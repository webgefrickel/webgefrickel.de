...
var frckl = {"scheme":"http","proxy":"wgf.localhost","port":3000,"src":"./src/","root":"./public/","dest":"./public/assets/","tasks":"./tasks/","pages":["/","/blog","/blog/styling-form-elements","/blog/photos-from-new-zealand","/blog/beyond-tellerrand-and-indiewebcamp-2016","/work","/contact","/legal-notice"]};

// Update 'version' if you need to refresh the cache
const baseUrl = 'https://webgefrickel.de';
const cacheVersion = version; // gets replaced with package.version
const assetsPath = frckl.dest.replace(frckl.root, '/');
const alwaysCache = [
  '/',
  '/offline',
  '/contact',
